    ...
    <>
      ...
      <div style={{ display: "flex", justifyContent: 'center', alignItems: "center" }} position='sticky'>
        <div style={{ width: "100vw" }}>
          <h1><center>MY HISTORY</center></h1>
                  ...
                  <CardActionArea>
                    <CardContent>
                      ...
                      <TableContainer style={{ width: "14rem" }}>
                        <Table >
                          <TableRow >
                            <TableCell sx={{ align: "center", fontWeight: "bold", color: "green", fontSize: "20px" }}>Bought For: </TableCell>
                            <TableCell sx={{ align: "center", fontWeight: "bold", color: "green", fontSize: "20px" }}>Farmer Name: </TableCell>
                          </TableRow>
                          <TableRow>
