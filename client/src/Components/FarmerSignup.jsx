...
const FarmerSignup = () => {
    const paperStyle = { padding: '30px 20px',height:'85vh', width: '60vw', margin: "20px auto" }
        ...
        <Grid>
            <Paper elevation={20} style={paperStyle}>
                ...
                <form style={{flexDirection:'row'}}>
                    <TextField style={{width:'51vw', marginLeft:'15px'}} label='Name' placeholder="Enter your name" />
                    ...
                    <TextField style={tfieldStyle} label='Confirm Password' placeholder="Confirm your Password" type='password'/>
                    <TextField style={tfieldStyle} label='Land Area' placeholder="Enter your Land Area"/>
